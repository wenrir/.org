...
#+begin_src sh :results silent
git clone https://aur.archlinux.org/evremap-git.git
cd evremap-git
makepkg -Acs --needed
#+end_src
*** Daemon
#+begin_src conf :dir /sudo:: :tangle /usr/lib/systemd/system/evremap.service :comments yes
[Service]
WorkingDirectory=/
...
** Config
#+begin_src toml :tangle /etc/evremap.toml :comments yes :dir /sudo::
