...
(map! :map general-override-mode-map
      ...
      :n "M-s-n" #'neotree-toggle
      :n "M-s-[" #'+tabs:previous-or-goto
      :n "M-s-]" #'+tabs:next-or-goto
      :n "M-s-q" #'kill-current-buffer
      ;;:n "M-s-o" #'bufler
      :n "M-s-o" #'ibuffer
      :i "M-s-o" #'sly-mrepl-clear-repl
      :n "M-s-y" #'sly
      :n "M-s-\\" #'window-split-toggle
      :n "M-s-/" #'which-key-show-full-keymap
...
(require 'org)
(after! org
  (setq org-directory "~/git/notes/org/"))

(after! org-agenda
  (setq org-agenda-files (list "~/git/notes/org/todo.org"
                               "~/git/notes/org/work.org")))
...
#+name: org-jira
#+begin_src emacs-lisp
(setq jiralib-url "https://lexxpluss.atlassian.net/")
(setq org-jira-working-dir "/home/user/git/notes/org/jira")
...
(after! org-roam
  :custom
  (setq org-roam-directory "~/git/notes/roam")
  :config
...
(use-package! ox-timeline
    :after org-mode
    :config (setq org-timeline-source-url "~/.config/emacs/modules/timeline/dist"))
#+end_src

#+RESULTS: org-timeline
...
#+RESULTS: Doom dash keymap
| Recently opened files      | :icon | (nerd-icons-faicon nf-fa-file_text :face 'doom-dashboard-menu-title)   | :action | recentf-open-files                                                                                                                                                             |         |                                             |         |                     |
| Reload last session        | :icon | (nerd-icons-octicon nf-oct-history :face 'doom-dashboard-menu-title)   | :when   | (cond ((modulep! :ui workspaces) (file-exists-p (expand-file-name persp-auto-save-fname persp-save-dir))) ((require 'desktop nil t) (file-exists-p (desktop-full-file-name)))) | :action | doom/quickload-session                      |         |                     |
| Open project               | :icon | (nerd-icons-octicon nf-oct-briefcase :face 'doom-dashboard-menu-title) | :action | projectile-switch-project                                                                                                                                                      |         |                                             |         |                     |
| Open private configuration | :icon | (nerd-icons-octicon nf-oct-tools :face 'doom-dashboard-menu-title)     | :when   | (file-directory-p doom-user-dir)                                                                                                                                               | :action | doom/open-private-config                    |         |                     |
| Open documentation         | :icon | (nerd-icons-octicon nf-oct-book :face 'doom-dashboard-menu-title)      | :action | doom/help                                                                                                                                                                      |         |                                             |         |                     |
| www lookup                 | :key  | w                                                                      | :icon   | (all-the-icons-octicon telescope :face 'doom-dashboard-menu-title)                                                                                                             | :action | +lookup/online                              |         |                     |
| vterm                      | :key  | v                                                                      | :icon   | (all-the-icons-octicon terminal :face 'doom-dashboard-menu-title)                                                                                                              | :action | multi-vterm                                 |         |                     |
| recent files               | :key  | R                                                                      | :action | consult-recent-file                                                                                                                                                            |         |                                             |         |                     |
| previous buffer            | :key  | p                                                                      | :action | previous-buffer                                                                                                                                                                |         |                                             |         |                     |
| www lookup                 | :key  | w                                                                      | :icon   | (all-the-icons-faicon eye :face 'doom-dashboard-menu-title)                                                                                                                    | :face   | (:inherit (doom-dashboard-menu-title bold)) | :action | +lookup/online      |
| vterm                      | :key  | v                                                                      | :icon   | (all-the-icons-alltheicon terminal-alt :face 'doom-dashboard-menu-title)                                                                                                       | :face   | (:inherit (doom-dashboard-menu-title bold)) | :action | multi-vterm         |
| recent files               | :key  | R                                                                      | :icon   | (all-the-icons-faicon files-o :face 'doom-dashboard-menu-title)                                                                                                                | :face   | (:inherit (doom-dashboard-menu-title bold)) | :action | consult-recent-file |
| previous buffer            | :key  | p                                                                      | :icon   | (all-the-icons-octicon pulse :face 'doom-dashboard-menu-title)                                                                                                                 | :face   | (:inherit (doom-dashboard-menu-title bold)) | :action | previous-buffer     |
...
#+RESULTS:
: /home/user/.config/doom/misc/images/meditate.svg
...
#+begin_src emacs-lisp
(after! dap-mode
  (dap-register-debug-template "LexxTest runtest (Auto main)"
    (list :type "python"
          :args (list "--data" "{\"repo\": \"LexxAuto\", \"branch\": \"main\"}")
          :cwd "/home/user/git/LexxTest"
          :target-module "/home/user/git/LexxTest/runtest.py"
          :request "launch"
          :name "LexxTest"))
  (dap-register-debug-template "LexxTest runtest (Msgsim (no A20)"
    (list :type "python"
          :args (list "--data" "{\"repo\": \"LexxMsgsim\", \"body\": \"/test test_airbic_a20=FALSE\", \"args\": {\"/home/user/git/LexxTest/test_setup\": null, \"/home/user/git/LexxTest/test_msgsim\": null, \"--wp=/home/user/tmp/test/\": null}}")
          :cwd "/home/user/git/LexxTest"
          :target-module "/home/user/git/LexxTest/runtest.py"
          :request "launch"
          :name "LexxTest"))
  (dap-register-debug-template "LexxTest pytest (Msgsim (no A20)"
    (list :type "python"
          :module "pytest"
          :args (list "-s" "--log_path=/home/user/git/LexxTest/.cache/log/run-ef3985889656" "--data_file=/home/user/git/LexxTest/.cache/log/run-ef3985889656/test_env.pkl" "/home/user/git/LexxTest/test_setup" "/home/user/git/LexxTest/test_msgsim" "--wp=/home/user/tmp/test/" "--no-clean")
          :cwd "/home/user/git/LexxTest"
          :request "launch"
          :name "LexxTest")))
#+end_src
